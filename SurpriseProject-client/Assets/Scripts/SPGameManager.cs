...
namespace SP
{
	...
	{
		public SPGameEventType EventType;
		...
		public SPGameEvent(SPGameEventType eventType, Character originCharacter)
		{
			EventType = eventType;
			OriginCharacter = originCharacter;
		}
		
		static SPGameEvent e;
		public static void Trigger(SPGameEventType eventType, Character originCharacter)
		{
	...
	public class SPGameManager : MMPersistentSingleton<SPGameManager>,
								MMEventListener<SPGameEvent>
	{
		...
		public virtual void OnMMEvent(SPGameEvent engineEvent)
		{
			switch (engineEvent.EventType)
			{
				case SPGameEventType.TogglePause:
					if (Paused)
					{
						SPGameEvent.Trigger(SPGameEventType.UnPause, null);
					}
					else
					{
                        SPGameEvent.Trigger(SPGameEventType.Pause, null);
					}
					break;
				case SPGameEventType.Pause:
					Pause();
					break;

				case SPGameEventType.UnPause:
					UnPause();
					break;
			}
		}
